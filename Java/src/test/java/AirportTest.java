...
public class AirportTest {
    ...
    @Test
    public void testGetMilitaryPlanesTypeTransport() {
        Airport airport = new Airport(planes);
        for (MilitaryPlane militaryPlane : airport.getMilitaryPlanesTypeTransport()) {
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        Airport airport = new Airport(planes);
        if (airport.getMilitaryPlanesTypeBomber() == null) Assert.fail();
    }
